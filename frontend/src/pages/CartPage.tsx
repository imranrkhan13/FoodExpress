          ...
          <div className="text-center py-20">
            <div className="inline-block p-8 bg-gray-900/50 rounded-3xl border border-gray-800 backdrop-blur-sm">
              <div className="relative mb-6">
                ...
                <ShoppingCart className="w-24 h-24 text-gray-600 mx-auto relative" />
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              {cart.map((item, idx) => (
                <div
                  key={item.id}
                  className="group relative bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 hover:border-orange-500/50 transition-all duration-300"
                  style={{
                  ...
                  <div className="flex gap-6">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-4 mb-3">
                        <div className="flex-1 min-w-0">
                          <h3 className="text-xl font-bold mb-1 truncate group-hover:text-orange-400 transition">
                            {item.name}
                          </h3>
                        ...
                        <button
                          ...
                          className="p-2 bg-red-500/10 hover:bg-red-500/20 border border-red-500/30 hover:border-red-500/50 rounded-lg text-red-400 hover:text-red-300 transition-all duration-300 group/btn"
                          title="Remove item"
                        >
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-3 bg-gray-800/50 border border-gray-700 rounded-xl px-2 py-1">
                          <button
                            onClick={() => decreaseQty(item.id)}
                            className="p-2 hover:bg-orange-500/20 rounded-lg text-orange-400 hover:text-orange-300 transition-all duration-300 active:scale-95"
                          >
              ...
              <button
                onClick={clearCart}
                className="w-full mt-6 py-4 bg-gray-800/50 hover:bg-red-500/10 border-2 border-gray-700 hover:border-red-500/50 text-gray-300 hover:text-red-400 font-bold rounded-xl transition-all duration-300 flex items-center justify-center gap-2 group"
              >
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-6">
                <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 space-y-6">
                  ...
                  <button
                    onClick={() => navigate("/")}
                    className="w-full py-3 px-6 bg-gray-800/50 hover:bg-gray-800 border border-gray-700 hover:border-orange-500/50 text-gray-300 hover:text-white font-semibold rounded-xl transition-all duration-300"
                  >
                    Continue Shopping
                  </button>
                </div>
